...
setup(
  ...
  url = 'https://github.com/ResidentMario/watsongraph/tarball/0.1.1', # use the URL to the github repo
  download_url = 'https://github.com/ResidentMario/watson-graph/tarball/0.1.1', # I'll explain this in a second
